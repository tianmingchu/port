  ...
  <article className="card">
    <div className="card-wrapper">
      ...
      <div className={(props.vid) ? "vid-body" : "img-body"}>
        <h2><strong>{props.title}</strong><a href={props.link} target="_blank"><img className="card-icon" src={require(`../../../assets/projects/${props.icon}`)} width="36px" style={{float: "right", marginRight: "5px", marginTop:"1px"}} alt={props.title} /></a></h2>
        <p>{props.body}</p>
      </div>
    </div>
  </article>
